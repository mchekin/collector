...
use Collector\Factory;
use Collector\IO\IOInterface;
use Collector\Config;
use Collector\Downloader\TransportException;
...
class Bitbucket
{
    ...
    public function authorizeOAuthInteractively($originUrl, $message = null)
    {
        ...
        $this->io->writeError(sprintf('to create a consumer. It will be stored in "%s" for future use by Collector.', $this->config->getAuthConfigSourceName()));
        ...
        $this->config->removeConfigSetting('http-basic.' . $originUrl);
    ...
    {
        $this->config->removeConfigSetting('bitbucket-oauth.'.$originUrl);
        ...
        $this->config->addConfigSetting('bitbucket-oauth.'.$originUrl, $consumer);
    }
